...
const Payment_option_case_ant = props => {
						...
						<div className="ltBox">
							<div className="shadowBox tp2">
								...
								<div className="list price">
									...
									<div className="rt"><span className="roboto">0원</span></div>
								</div>
							</div>
						</div>
						<div className="rtButtons">
							<Link to="/payment/payment_coupon" className="btns yellow bold shadow block">쿠폰 / 포인트</Link>
							<UiButton className="btns red bold shadow block motion01">주문 완료</UiButton>
...
Payment_option_case_ant.defaultProps = defaultProps;
export default Payment_option_case_ant;