...
//가짜데아타
import dummy_data from '../dummy_data2'



let cartListIndex = 0;
const Order11 = props => {
	const productMenuListGroupColRow = [1, 1]; //메뉴목록을 1*1 으로
	const [prdVisible, setPrdVisible] = useState('')
	const [productCategoryList, setProductCategoryList] = useState(['이용권']);
	...
	return (
		<div id="order">
			...
			<div className={`orderProductList orderListCol${productMenuListGroupColRow[0]}`}>
														...
														<div className={`uiCol${12 / productMenuListGroupColRow[0]}`} style={
															...
															<UiItem size={
																productMenuListGroupColRow[0] === 1
																	? productMenuListGroupColRow[1] === 1
																		? 'row11' // 칸 1*1
																		: 'row1'
